...
namespace SUP.ViewModels
{
    ...
    public class MainShellViewModel
    {
        ...
        private Regex regex = new Regex(@"^[0-9A-Öa-ö.\s_-]+$"); //https://stackoverflow.com/questions/13353663/what-is-the-regular-expression-to-allow-uppercase-lowercase-alphabetical-charac
